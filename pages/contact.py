...
from services.supabase_service import get_user_messages, send_message, mark_messages_as_read
...
def show_contact(supabase):
    ...
    chat_html_parts = []
    chat_html_parts.append('''<html><head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <style>
    body { margin: 0; background: #0B1B2B; font-family: "Inter", sans-serif; color: #F0F4F8; }
    ...
    </style></head><body><div class="chat-wrapper"><div class="chat-messages">''')
    ...
    chat_html_parts.append('</div></div></body></html>')
