...
def _comparison_page(comparison_cars):
    """Render the comparison view for selected cars – fixed Arrow conversion."""
    ...
    # Build comparison data as strings to avoid Arrow errors
    ...
    # Force all columns to string to avoid Arrow errors
